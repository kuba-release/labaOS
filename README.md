...
### 1. Реализация функции на C++ (main.cpp)

<img width="456" height="292" alt="image" src="https://github.com/user-attachments/assets/74f6a2e5-e2be-46e7-ad2b-022abb5d6c2b" />

## 2. Компиляция в ассемблерный код

<img width="876" height="142" alt="image" src="https://github.com/user-attachments/assets/3807f6c5-7743-4e62-aedf-75d338b98d1a" />

### Без оптимизации (-O0)

<img width="741" height="832" alt="image" src="https://github.com/user-attachments/assets/147d57b8-363b-4d69-a6c3-f4beace60d9e" />

<img width="873" height="648" alt="image" src="https://github.com/user-attachments/assets/3856ad2d-c967-451d-a4e7-1d08e1f910bd" />

### С оптимизацией (-O3)

<img width="874" height="873" alt="image" src="https://github.com/user-attachments/assets/94986329-5faf-4b2f-b86b-d210ed99fcba" />

<img width="672" height="710" alt="image" src="https://github.com/user-attachments/assets/7bae45fe-fbd7-4d73-bdc9-0995e6c3768c" />
...
#### В текстовых файлах (. t x t ) найти заданную в параметре сценария строку, из найденных файлов составить список, сохранить его в файл.
